...
using OrderApplication.Orders.Commands.UpdateOrder.OrderApplication.Orders.Commands.UpdateOrder;
using OrderApplication.Orders.DTOs;
using OrderApplication.Services;
using OrderDomain.Orders;
using OrderPersistence;

public sealed class PaymentAutoStartKafkaWorker : BackgroundService
{
    private readonly IServiceProvider serviceProvider;

    public PaymentAutoStartKafkaWorker(IServiceProvider serviceProvider)
    {
